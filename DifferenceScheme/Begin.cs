    ...
    public partial class Begin : Form
    {
        ...
        private void solveMatrix(ref double[,] oldM, ref double[,] newM, int index, double time, bool isVertical)
        {
            ...
            if (isVertical)
            {
                for (int i = 0; i < n; i++)
                {
                    F[i] = (kappa * oldM[i,index + 1] +
                    (1 - 2 * kappa) * oldM[i,index] +
                    kappa * oldM[i,index - 1]);
                }
            ...
            else
            {
                for (int i = 0; i < n; i++)
                {
                    F[i] = (kappa * oldM[index + 1,i] +
                    (1 - 2 * kappa) * oldM[index,i] +
                    kappa * oldM[index - 1,i]);
                }
        ...
        {            
            ...
            System.Console.WriteLine("kappa =  " + kappa);
            System.Console.WriteLine("tau =  " + tau);
